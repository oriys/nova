...
install_firecracker() {
    ...
    local firecracker_bin
    local jailer_bin
    firecracker_bin=$(ls ${tmp}/release-*/firecracker-${FC_VERSION}-x86_64)
    jailer_bin=$(ls ${tmp}/release-*/jailer-${FC_VERSION}-x86_64)
    cp "${firecracker_bin}" /usr/local/bin/firecracker
