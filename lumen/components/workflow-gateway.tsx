...
export function WorkflowGateway({ workflowName }: WorkflowGatewayProps) {
  const t = useTranslations("workflowDetailPage.gateway")
  ...
  const fetchRoutes = useCallback(async () => {
    ...
    try {
      ...
      setRoutes(allRoutes.filter((r) => r.workflow_name === workflowName))
    } catch {
      setRoutes([])
    } finally {
      setLoading(false)
