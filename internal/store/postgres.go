...
var builtinRuntimeSeeds = []builtinRuntimeSeed{
	{ID: "python", Name: "Python", Version: "3.14.3"},
	{ID: "node", Name: "Node.js", Version: "24.13.0"},
	{ID: "go", Name: "Go", Version: "1.26.0"},
	{ID: "rust", Name: "Rust", Version: "1.93.1"},
	{ID: "java", Name: "Java", Version: "21.0.10"},
	{ID: "kotlin", Name: "Kotlin", Version: "2.3.10"},
	{ID: "scala", Name: "Scala", Version: "3.8.2"},
	{ID: "c", Name: "C", Version: "14.2.0"},
	{ID: "cpp", Name: "C++", Version: "14.2.0"},
	{ID: "ruby", Name: "Ruby", Version: "3.4.8"},
	{ID: "php", Name: "PHP", Version: "8.4.17"},
	{ID: "deno", Name: "Deno", Version: "2.7.2"},
	{ID: "bun", Name: "Bun", Version: "1.3.10"},
	{ID: "graalvm", Name: "GraalVM", Version: "21.0.2"},
	{ID: "elixir", Name: "Elixir", Version: "1.18.3"},
	{ID: "swift", Name: "Swift", Version: "6.2.0"},
...
func (s *PostgresStore) ensureSchema(ctx context.Context) error {
	...
	stmts := []string{
		...
		// Remove legacy Marketplace/App Store tables.
		`DROP TABLE IF EXISTS app_store_jobs CASCADE`,
		`DROP TABLE IF EXISTS app_store_installation_resources CASCADE`,
		`DROP TABLE IF EXISTS app_store_installations CASCADE`,
		`DROP TABLE IF EXISTS app_store_releases CASCADE`,
