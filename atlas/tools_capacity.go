...
func RegisterCapacityTools(s *mcp.Server, c *NovaClient) {
	...
	addToolHelper(s, &mcp.Tool{
		...
		if args.MaxInflight != nil { body["max_inflight"] = *args.MaxInflight }
		if args.MaxQueueDepth != nil { body["max_queue_depth"] = *args.MaxQueueDepth }
		if args.MaxQueueWaitMs != nil { body["max_queue_wait_ms"] = *args.MaxQueueWaitMs }
		if args.ShedStatusCode != nil { body["shed_status_code"] = *args.ShedStatusCode }
