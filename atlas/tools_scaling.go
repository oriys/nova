...
func RegisterScalingTools(s *mcp.Server, c *NovaClient) {
	...
	addToolHelper(s, &mcp.Tool{
		...
		if args.MinReplicas != nil { body["min_replicas"] = *args.MinReplicas }
		if args.MaxReplicas != nil { body["max_replicas"] = *args.MaxReplicas }
		if args.TargetUtilization != nil { body["target_utilization"] = *args.TargetUtilization }
		if args.CooldownScaleUpS != nil { body["cooldown_scale_up_s"] = *args.CooldownScaleUpS }
		if args.CooldownScaleDownS != nil { body["cooldown_scale_down_s"] = *args.CooldownScaleDownS }
