...
func main() {
	...
	RegisterTenantPermTools(server, client)
	...
	RegisterRateLimitTools(server, client)
	RegisterSLOTools(server, client)
	...
	RegisterPrewarmTools(server, client)
	RegisterStateTools(server, client)
	RegisterDLQTools(server, client)
	RegisterBackendTools(server, client)
